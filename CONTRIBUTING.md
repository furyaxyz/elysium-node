...
Thank you for your interest in contributing to Elysium-Node!

All work on the code base should be motivated by [our Github
issues](https://github.com/elysiumorg/elysium-node/issues). If you
would like to work on an issue which already exists, please indicate so
by leaving a comment.

All new contributions should start with a [Github
issue](https://github.com/elysiumorg/elysium-node/issues/new/choose). The
...
We follow the [Go style guide on commit messages](https://tip.golang.org/doc/contribute.html#commit_messages). Write concise commits that start with the package name and have a description that finishes the sentence "This change modifies Elysium-Node to...". For example,
