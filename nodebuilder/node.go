...
// Node represents the core structure of a Elysium node. It keeps references to all
// Elysium-specific components and services in one place and provides flexibility to run a
// Elysium node in different modes. Currently supported modes:
// * Bridge
// * Light
// * Full
type Node struct {
