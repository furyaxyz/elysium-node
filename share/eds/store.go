...
// registered on the Store. NOTE: The blockstore does not store whole Elysium Blocks but IPFS
...
// store whole Elysium Blocks but IPFS blocks. We represent `shares` and NMT Merkle proofs as IPFS
