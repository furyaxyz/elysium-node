...
func init() {
	...
	addr, err := sdk.AccAddressFromBech32("elysium1377k5an3f94v6wyaceu0cf4nq6gk2jtpc46g7h")
	if err != nil {
		panic(err)
	}
	...
	valAddr, err := sdk.ValAddressFromBech32("elysiumvaloper1q3v5cugc8cdpud87u4zwy0a74uxkk6u4q4gx4p")
	if err != nil {
		panic(err)
	}
